...
public class Box2DCollider extends ed_Collider2D {
    ...
    private final Vector2f size = new Vector2f(0.25f);
    ...
    public void editorUpdate() {
        ...
        DebugDraw.addBox2D(center, new Vector2f(this.size).mul(this.gameObject.transform.scale.x, this.gameObject.transform.scale.y).mul(4), this.gameObject.transform.rotation);
    }
    ...
    @Override
    public void imgui() {
        EditorGUI.field_Vector2f("Size", this.size, new Vector2f(0.25f), EditorGUI.DEFAULT_FLOAT_FORMAT + "m");
